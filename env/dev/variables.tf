...
# Private EC2-2
variable "Private_EC2_2_ami"           { default = "ami-02c3627b04781eada" }
variable "Private_EC2_2_instance_type" { default = "t3.micro" }
variable "Private_EC2_2_key_name"      { default = "tokyo-ec2-key" }
variable "Private_EC2_2_volume_size"   { default = 8 }